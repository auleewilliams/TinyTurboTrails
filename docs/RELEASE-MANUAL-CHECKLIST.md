...
| 2 | Start with Space / any standard face button (A/B/X/Y). Move both ways with arrows and A/D / D-pad and stick. Jump, release early for a shorter jump, and pause/resume with Escape / Start. | Not run |
...
| 11 | Finish with collected gems, check the total and celebration, then replay with Space / any standard face button (A/B/X/Y). Start again and verify gems and checkpoint return to fresh-run state. | Not run |
