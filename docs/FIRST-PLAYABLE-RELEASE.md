...
`npm run test:browser`. `npm test` currently covers 43 unit tests in 10 files.
The hosted run [34886036182](https://github.com/auleewilliams/TinyTurboTrails/actions/runs/34886036182)
